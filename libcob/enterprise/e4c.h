...
#ifdef _MSC_VER 
#define try __try
#define catch(a) __except(a)
#define RuntimeException EXCEPTION_EXECUTE_HANDLER
#define e4c_context_is_ready() 1
#define e4c_context_begin(a)  ;  
#define e4c_context_end()    ;
#define e4c_context_begin(a) ;   
#define E4C_TRUE 1
#define throw(e,m)  RaiseException(e,0,0,0)
